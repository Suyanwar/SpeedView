...
abstract class Gauge constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr), Observer {
    ...
    private fun init() {
        ...
        sections.add(Section(.17f, -0xff0100).inGauge(this))
        sections.add(Section(.34f, -0x100).inGauge(this))
        sections.add(Section(.51f, -0x10000).inGauge(this))
        sections.add(Section(.68f, -0xff0100).inGauge(this))
        sections.add(Section(.84f, -0x100).inGauge(this))
